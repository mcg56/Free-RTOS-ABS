...
/****************************************************************************
 circBufT.h:
 File containing the functions related to the circular buffer. The functions
 include initialising, reading, writing and freeing the circular buffer. The
 circular buffer is used t find the altitude of the helicopter.
